...
int main()
{
    ...
    Sphere* sphere1 = new Sphere(center, 5.0f, sColor);
    ...
    //Sphere 3 variables
    Vec3f center3(-10.0f, 0.0f, 10.0f);
    ...
    //Light variables
    Vec3f position(10.0f, 10.0f, -10.0f);
    ...
    printf("Sphere1 ambientColor\n");
    sphere1->getMaterial().getAmbientColor().print();
